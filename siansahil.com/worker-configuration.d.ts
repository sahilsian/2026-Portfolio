/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: 99d04de3786798d80c05db9921c6a3ee)
// Runtime types generated with workerd@1.20251202.0 2025-09-02 nodejs_compat
declare namespace Cloudflare {
	interface Env {
		VITE_STRAPI_GRAPHQL_URL: string;
		VITE_STRAPI_ROOT: string;
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "VITE_STRAPI_GRAPHQL_URL" | "VITE_STRAPI_ROOT" | "VITE_STRAPI_URL">> {}
}
